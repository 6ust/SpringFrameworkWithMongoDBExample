...
public class DataInitializer implements ApplicationListener<ContextRefreshedEvent> {
	...
	public void onApplicationEvent(ContextRefreshedEvent arg0) {
		...
		System.out.println(userRepository.findByNameIgnoreCaseLike("Wal").getName());
		System.out.println(userRepository.findByEmailQualquerCoisa("rect@gmail.com").getName());
	}
